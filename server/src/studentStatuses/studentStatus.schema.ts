...
export const studentStatuses = [
  ...
  { id: 28, text: 'Сдан экзамен 0 фазы' },
  { id: 29, text: 'Сдан экзамен 1 фазы' },
  { id: 30, text: 'Сдан экзамен 2 фазы' },
  { id: 31, text: 'Сдан экзамен 3 фазы' },
  { id: 32, text: 'Неуспешная попытка сдать экзамен 0 фазы' },
  { id: 33, text: 'Неуспешная попытка сдать экзамен 1 фазы' },
  { id: 34, text: 'Неуспешная попытка сдать экзамен 2 фазы' },
  { id: 35, text: 'Неуспешная попытка сдать экзамен 3 фазы' },
] as const;
...
export enum StudentStatusTextEnum {
  ...
  exam0 = 'Сдан экзамен 0 фазы',
  exam1 = 'Сдан экзамен 1 фазы',
  exam2 = 'Сдан экзамен 2 фазы',
  exam3 = 'Сдан экзамен 3 фазы',
  failExam0 = 'Неуспешная попытка сдать экзамен 0 фазы',
  failExam1 = 'Неуспешная попытка сдать экзамен 1 фазы',
  failExam2 = 'Неуспешная попытка сдать экзамен 2 фазы',
  failExam3 = 'Неуспешная попытка сдать экзамен 3 фазы',
}
